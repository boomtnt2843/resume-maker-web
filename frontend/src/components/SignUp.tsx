      ...
      <form className="form-signup" id="signUpForm">
        <div className="box-signup">
          ...
          <input
            ...
            className="signUp-input"
            id="re_password"
            onChange={headleInputChange_repassword}
            placeholder="repeat password..."
          />
          <p className="errorInput" id="errorInput">
            Error
          </p>
        </div>
        <button type="button" className="enter-signup-btn" onClick={signUp}>
          SIGN UP
        </button>
      </form>
      <button className="back-home-btn" onClick={toHome}>
        BACK HOME
      </button>
    </div>
  );
