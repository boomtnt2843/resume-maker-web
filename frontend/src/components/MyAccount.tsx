    ...
    return (
      <div>
        <div className="container-header-into">
          ...
          <button className="let-first-btn" onClick={createNewAcc}>
            Let's Go!
          </button>
        </div>
      </div>
        ...
        {myInfo.firstName !== undefined && myInfo.firstName !== "" ? (
          <div className="text-already">
            <div className="text-already-zone">
              ...
              <button className="move-btn" onClick={toResume}>
                Let's Go To Resume
              </button>
              <div className="copy-link">
                <input
                  ...
                  defaultValue={"http://localhost:3000/resume?user=" + myId}
                  disabled
                />
            ...
            <div className="qrcode-zone">
              <img
                id="barcode"
                src={
                  "https://api.qrserver.com/v1/create-qr-code/?size=170x170&data=http://localhost:3000/resume?user=" +
                  myId
                }
              ...
              <a
                id="download-button"
                href={
                  "https://api.qrserver.com/v1/create-qr-code/?https://api.qrserver.com/v1/create-qr-code/?margin=0&download=1&size=170x170&data=http://localhost:3000/resume?user=" +
                  myId
                }
              >
                DOWNLOAD QRCODE
          ...
          <div className="text-not-ready">
            ...
            <button className="go-to-about-me" onClick={toAboutMe}>
              {" "}
              Let's Start Click Me
            </button>
          </div>
        )}
      </div>
