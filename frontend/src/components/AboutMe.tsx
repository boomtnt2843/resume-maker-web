...
function AboutMe() {
  ...
  const addHobby = () => {
    const hobbyInputBox = document.getElementById(
      "input-hobby"
    ) as HTMLInputElement;
  ...
  const addInterest = () => {
    const interestInputBox = document.getElementById(
      "input-interest"
    ) as HTMLInputElement;
    ...
    <div>
      ...
      <div className="container-aboutme">
        <form className="aboutme-form" onSubmit={submitForm}>
              ...
              <div className="add-hobby">
                <div className="box-input">
                  ...
                  <input
                    ...
                    className="info-input"
                    id="input-hobby"
                    onChange={(e) => setItemHobby(e.target.value)}
              ...
              <div className="interest-board">
                {interest.map((item: string, index) => (
                  <div className="interest-card" key={index}>
                    ...
                    <button
                      type="button"
                      className="delete-interest"
                      onClick={() => removeThisInterest(index)}
                    >
                      x
                    </button>
                  </div>
          ...
          <button type="submit" className="submit-aboutme">
