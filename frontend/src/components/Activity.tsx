                ...
                <div className="act-edit-form" id={item._id + "-edit-form"}>
                  <div className="location-edit-group">
                    ...
                    <input
                      type="text"
                      className="edit-box"
                      id={item._id + "-nameHeader"}
                      defaultValue={item.nameHeader}
                    />
