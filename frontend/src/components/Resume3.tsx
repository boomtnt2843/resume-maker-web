...
function Resume3() {
  ...
  const showpower = (power: number) => {
    ...
    for (let i = 0; i < power; i++) {
      imgPower.push(
        <h2 className="box-power-03" key={i}>
          <RiBearSmileFill />
        </h2>
      );
    }
  ...
  return (
    <div className="bear-container">
      <div className="header-name-03">
        <h1>Hello</h1>
        <h1>
          I am {myInfo.firstName} {myInfo.lastName}
        </h1>
        ...
        <div className="aboutme-box-03">
          ...
          {myInfo.birthDay !== undefined && myInfo.birthDay !== "" ? (
            <div className="birth-day-group" id="birth-day-group">
              ...
              <input
                type="date"
                className="show-birthday-03"
                defaultValue={
                  myInfo.birthDay === undefined
                    ? ""
                    : myInfo.birthDay.slice(0, 10)
                }
                disabled
              />
            </div>
            ...
            {myInfo.facebook !== undefined && myInfo.facebook !== "" ? (
              <div className="link-group-03" id="facebook-group">
                <a
                  ...
                  href={"https://www.facebook.com/" + myInfo.facebook}
                >
                  <BsFacebook /> Facebook
                </a>
              </div>
            ...
            {myInfo.linkedin !== undefined && myInfo.linkedin !== "" ? (
              <div className="link-group-03" id="linkedin-group">
                <a
                  ...
                  href={"https://www.linkedin.com/in/" + myInfo.linkedin}
                >
                  <BsLinkedin /> Linkedin
                </a>
              </div>
      ...
      {myInfo.generalskills !== undefined &&
      myInfo.generalskills.length !== 0 ? (
        <div className="general-skill-sec-03">
          <h1>General Skills</h1>
          <div className="skill-group-03">
            <div className="skill-zone-03">
              <img
                className="ima-obj-bear"
                src={require("../image/bear/Bear1.png")}
                alt="bear01"
              />
      ...
      {myInfo.technicalskills !== undefined &&
      myInfo.technicalskills.length !== 0 ? (
        <div className="technical-skill-sec-03">
          ...
          <div className="skill-group-03">
            <div className="skill-zone-03">
              <img
                className="ima-obj-bear"
                src={require("../image/bear/Bear2.png")}
                alt="bear02"
              />
              <div className="tier-power-03">
                <p></p>
        ...
        <div className="languages-skill-sec-03">
          ...
          <div className="skill-group-03">
            <div className="skill-zone-03">
              <img
                className="ima-obj-bear"
                src={require("../image/bear/Bear3.png")}
                alt="bear03"
              />
              <div className="tier-power-03">
                <p></p>
      ...
      {myInfo.activities !== undefined && myInfo.activities.length !== 0 ? (
        <div className="act-sec-03">
          <img
            className="ima-obj-bear"
            src={require("../image/bear/footprint3.png")}
            alt="bear01"
          />
          <img
            className="ima-obj-bear"
            src={require("../image/bear/footprint4.png")}
            alt="bear02"
          />
          <img
            className="ima-obj-bear"
