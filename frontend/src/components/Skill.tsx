...
function Skill() {
  ...
  const nameGeneralHead = document.getElementById(
    "general-name-input"
  ) as HTMLDivElement;
  const nameGeneralInput = nameGeneralHead?.querySelector(
    "input"
  ) as HTMLInputElement;
  const nameTechnicalHead = document.getElementById(
    "technical-name-input"
  ) as HTMLDivElement;
  const nameTechnicalInput = nameTechnicalHead?.querySelector(
    "input"
  ) as HTMLInputElement;
  const nameLanguageHead = document.getElementById(
    "language-name-input"
  ) as HTMLDivElement;
  const nameLanguageInput = nameLanguageHead?.querySelector(
    "input"
  ) as HTMLInputElement;
  ...
  const submitFormTechnical = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!errorInputCheck) {
      ...
      const technicalform = document.getElementById(
        "technical-form"
      ) as HTMLFormElement;
      technicalform.reset();
    }
  ...
  return (
    <div id="general">
      ...
      <div className="skill-menu">
        <a href="#general" className="skill-wrap">
          general skill
        </a>
        <a href="#technical" className="skill-wrap">
          technical skill
        </a>
        <a href="#language" className="skill-wrap">
          language
        </a>
      </div>
              ...
              <tbody>
                {generalSkills.map((item: skillInterface, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <button onClick={() => deleteGeneralSkill(item._id)}>
                        <FaTrashAlt />
                      </button>
                    </td>
                  </tr>
              ...
              <tbody>
                {technicalSkills.map((item: skillInterface, index) => (
                  <tr key={index}>
                    ...
                    <td>{String(item.power)}</td>
                    <td>
                      <button onClick={() => deleteTechnicalSkill(item._id)}>
                        <FaTrashAlt />
                      </button>
                    </td>
                  </tr>
            ...
            >
              ...
              <div className="box-input" id="technical-name-input">
                ...
                <input
                  ...
                  className="info-input"
                  id="name"
                  onChange={handleInputChangeTechnical}
                  placeholder="your skill..."
                />
                <small>something error</small>
              </div>
